		...
		<div class="shop__sidebar--widget widget__area d-none d-lg-block">
			<div class="single__widget widget__bg">
				...
				<ul class="widget__categories--menu">
					<li class="widget__categories--menu__list">
						<label class="widget__categories--menu__label d-flex align-items-center">
							...
							src="{{asset('web/assets/img/product/small-product1.png')}}" alt="categories-img">
					...
					<ul class="widget__categories--sub__menu">
						<li class="widget__categories--sub__menu--list">
							...
							src="{{asset('web/assets/img/product/small-product2.png')}}"
							alt="categories-img">
					...
					<li class="widget__categories--sub__menu--list">
						...
						href="{{url('/shop')}}">
						<img class="widget__categories--sub__menu--img"
						src="{{asset('web/assets/img/product/small-product3.png')}}"
						alt="categories-img">
				...
				<li class="widget__categories--sub__menu--list">
					...
					href="{{url('/shop')}}">
					<img class="widget__categories--sub__menu--img"
					src="{{asset('web/assets/img/product/small-product4.png')}}"
					alt="categories-img">
			...
			<li class="widget__categories--sub__menu--list">
				...
				href="{{url('/shop')}}">
				<img class="widget__categories--sub__menu--img"
				src="{{asset('web/assets/img/product/small-product5.png')}}"
				alt="categories-img">
...
<li class="widget__categories--menu__list">
	<label class="widget__categories--menu__label d-flex align-items-center">
		<img class="widget__categories--menu__img"
		src="{{asset('web/assets/img/product/small-product2.png')}}" alt="categories-img">
...
<li class="widget__categories--menu__list">
	<label class="widget__categories--menu__label d-flex align-items-center">
		<img class="widget__categories--menu__img"
		src="{{asset('web/assets/img/product/small-product3.png')}}" alt="categories-img">
...
<li class="widget__categories--menu__list">
	<label class="widget__categories--menu__label d-flex align-items-center">
		<img class="widget__categories--menu__img"
		src="{{asset('web/assets/img/product/small-product4.png')}}" alt="categories-img">
...
<li class="widget__categories--menu__list">
	<label class="widget__categories--menu__label d-flex align-items-center">
		<img class="widget__categories--menu__img"
		src="{{asset('web/assets/img/product/small-product5.png')}}" alt="categories-img">
		<span class="widget__categories--menu__text">Denim Jacket</span>
		<svg class="widget__categories--menu__arrowdown--icon"
		xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394">
		<path
		...
		<div class="product__items product__items--grid d-flex align-items-center">
			<div class="product__items--grid__thumbnail position__relative">
				<a class="product__items--link" href="{{url('/')}}">
					...
					src="{{asset('web/assets/img/product/small-product1.png')}}" alt="product-img">
					<img class="product__items--img product__secondary--img"
					src="{{asset('web/assets/img/product/small-product2.png')}}" alt="product-img">
				</a>
			</div>
			<div class="product__items--grid__content">
				<h3 class="product__items--content__title h4"><a
					href="{{url('/')}}">Women Fish Cut</a></h3>
...
<div class="product__items product__items--grid d-flex align-items-center">
	<div class="product__items--grid__thumbnail position__relative">
		<a class="product__items--link" href="{{url('/')}}">
			<img class="product__items--img product__primary--img"
			src="{{asset('web/assets/img/product/small-product3.png')}}" alt="product-img">
			<img class="product__items--img product__secondary--img"
			src="{{asset('web/assets/img/product/small-product4.png')}}" alt="product-img">
		</a>
	</div>
	<div class="product__items--grid__content">
		<h3 class="product__items--content__title h4"><a
			href="{{url('/')}}">Gorgeous Granite is</a></h3>
			<div class="product__items--price">
...
<div class="product__items product__items--grid d-flex align-items-center">
	<div class="product__items--grid__thumbnail position__relative">
		<a class="product__items--link" href="{{url('/')}}">
			<img class="product__items--img product__primary--img"
			src="{{asset('web/assets/img/product/small-product5.png')}}" alt="product-img">
			<img class="product__items--img product__secondary--img"
			src="{{asset('web/assets/img/product/small-product6.png')}}" alt="product-img">
		</a>
	</div>
	<div class="product__items--grid__content">
		<h4 class="product__items--content__title"><a
			href="{{url('/')}}">Durable A Steel </a></h4>
			<div class="product__items--price">
...
<div class="single__widget widget__bg">
	...
	<ul class="widget__tagcloud">
		<li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
			href="{{url('/shop')}}">Jacket</a></li>
			<li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
				href="{{url('/shop')}}">Women</a></li>
				<li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
					href="{{url('/shop')}}">Oversize</a></li>
					<li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
						href="{{url('/shop')}}">Cotton </a></li>
						<li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
							href="{{url('/shop')}}">Shoulder </a></li>
							<li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
								href="{{url('/shop')}}">Winter</a></li>
								<li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
									href="{{url('/shop')}}">Accessories</a></li>
									<li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
										href="{{url('/shop')}}">Dress </a></li>
									</ul>
								</div>
							</div>
						</div>
												...
												<div class="col mb-30">
													<div class="product__items ">
														...
														<div class="product__items--content">
															...
															Women</span>
															<h3 class="product__items--content__title h4"><a
																href="{{url('/')}}">Oversize Cotton Dress</a>
															</h3>
															<div class="product__items--price">
																<span class="current__price">$110</span>
																<span class="price__divided"></span>
...
<div class="col mb-30">
	<div class="product__items ">
		...
		<div class="product__items--content">
			...
			Women</span>
			<h3 class="product__items--content__title h4"><a
				href="{{url('/')}}">Boxy Denim Jacket</a></h3>
				<div class="product__items--price">
...
<div class="col mb-30">
	<div class="product__items">
		...
		<div class="product__items--content">
			...
			Women</span>
			<h4 class="product__items--content__title"><a
				href="{{url('/')}}">Quilted Shoulder Bag</a>
			</h4>
			<div class="product__items--price">
...
<div class="col mb-30">
	<div class="product__items">
		...
		<div class="product__items--content">
			...
			Women</span>
			<h4 class="product__items--content__title"><a
				href="{{url('/')}}">Square Shoulder Bag</a></h4>
				<div class="product__items--price">
	...
	<div class="product__items">
		<div class="product__items--thumbnail">
			<a class="product__items--link" href="{{url('/')}}">
				...
				<img class="product__items--img product__secondary--img"
				src="{{asset('web/assets/img/product/product10.png')}}"
				alt="product-img">
			</a>
			<div class="product__badge">
				<span class="product__badge--items sale">Sale</span>
		...
		<div class="product__items--content">
			...
			Women</span>
			<h4 class="product__items--content__title"><a
				href="{{url('/')}}">Light Denim Jacket</a></h4>
				<div class="product__items--price">
					<span class="current__price">$125</span>
					<span class="price__divided"></span>
...
<div class="col mb-30">
	<div class="product__items">
		<div class="product__items--thumbnail">
			<a class="product__items--link" href="{{url('/')}}">
				<img class="product__items--img product__primary--img"
				src="{{asset('web/assets/img/product/product11.png')}}"
				alt="product-img">
				<img class="product__items--img product__secondary--img"
				src="{{asset('web/assets/img/product/product12.png')}}"
				alt="product-img">
			</a>
			<div class="product__badge">
				<span class="product__badge--items sale">Sale</span>
...
<div class="col mb-30">
	<div class="product__items">
		<div class="product__items--thumbnail">
			<a class="product__items--link" href="{{url('/')}}">
				<img class="product__items--img product__primary--img"
				src="{{asset('web/assets/img/product/product13.png')}}"
				alt="product-img">
				<img class="product__items--img product__secondary--img"
				src="{{asset('web/assets/img/product/product14.png')}}"
				alt="product-img">
			</a>
			<div class="product__badge">
				<span class="product__badge--items sale">Sale</span>
		...
		<div class="product__items--content">
			...
			Women</span>
			<h4 class="product__items--content__title"><a
				href="{{url('/')}}">Aware organic cotton</a>
			</h4>
			<div class="product__items--price">
	...
	<div class="product__items">
		<div class="product__items--thumbnail">
			<a class="product__items--link" href="{{url('/')}}">
				...
				alt="product-img">
				<img class="product__items--img product__secondary--img"
				src="{{asset('web/assets/img/product/product15.png')}}"
				alt="product-img">
			</a>
			<div class="product__badge">
				<span class="product__badge--items sale">Sale</span>
		...
		<div class="product__items--content">
			...
			Women</span>
			<h4 class="product__items--content__title"><a
				href="{{url('/')}}">Western denim shirt</a></h4>
				<div class="product__items--price">
					<span class="current__price">$115</span>
					<span class="price__divided"></span>
...
<div class="col mb-30">
	<div class="product__items">
		...
		<div class="product__items--content">
			...
			Women</span>
			<h4 class="product__items--content__title"><a
				href="{{url('/')}}">High Ankle Jeans</a></h4>
				<div class="product__items--price">
...
<div class="col mb-30">
	<div class="product__items">
		...
		<div class="product__items--content">
			...
			Women</span>
			<h4 class="product__items--content__title"><a
				href="{{url('/')}}">OSmock Mini Dresss</a></h4>
				<div class="product__items--price">
					<span class="current__price">$110</span>
					<span class="price__divided"></span>
					<span class="old__price">$78</span>
...
<div class="col mb-30">
	...
	<div class="product__list--items__content">
		...
		Women</span>
		<h3 class="product__list--items__content--title h4 mb-10"><a
			href="{{url('/')}}">Square Shoulder Bag</a></h3>
			<div class="product__list--items__price mb-10">
...
<div class="col mb-30">
	...
	<div class="product__list--items__content">
		...
		Women</span>
		<h3 class="product__list--items__content--title h4 mb-10"><a
			href="{{url('/')}}">Light Denim Jackets</a></h3>
			<div class="product__list--items__price mb-10">
	...
	<nav class="pagination justify-content-center">
		<ul class="pagination__wrapper d-flex align-items-center justify-content-center">
			<li class="pagination__list">
				<a href="{{url('/shop')}}" class="pagination__item--arrow  link ">
			...
			<li>
				<li class="pagination__list"><span
					...
					<li class="pagination__list"><a href="{{url('/shop')}}"
