					...
					<div class="breadcrumb__content text-center">
						...
						<ul class="breadcrumb__content--menu d-flex justify-content-center">
							<li class="breadcrumb__content--menu__items"><a class="text-white"
								href="{{url('/')}}">Home</a></li>
								<li class="breadcrumb__content--menu__items"><span class="text-white">About Us</span>
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="col-lg-6">
						<div class="about__thumb d-flex">
							<div class="about__thumb--items">
								...
								src="{{asset('web/assets/img/other/about-thumb-list1.png')}}" alt="about-thumb">
							</div>
							<div class="about__thumb--items position__relative">
								<img class="about__thumb--img border-radius-5 display-block"
								src="{{asset('web/assets/img/other/about-thumb-list2.png')}}" alt="about-thumb">
...
<div class="col-lg-6">
	<div class="about__content">
		...
		<div class="about__author position__relative d-flex align-items-center">
			...
			<img class="about__author--signature display-block" src="{{asset('web/assets/img/icon/signature.png')}}"
			alt="signature">
		</div>
	</div>
</div>
				...
				<div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
					<div class="team__items text-center">
						<div class="team__thumb">
							<img class="team__thumb--img border-radius-50" src="{{asset('web/assets/img/other/team1.png')}}"
							alt="">
						</div>
...
<div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
	<div class="team__items text-center">
		<div class="team__thumb">
			<img class="team__thumb--img border-radius-50" src="{{asset('web/assets/img/other/team2.png')}}"
			alt="">
		</div>
		<div class="team__content">
...
<div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
	<div class="team__items text-center">
		<div class="team__thumb">
			<img class="team__thumb--img border-radius-50" src="{{asset('web/assets/img/other/team3.png')}}"
			alt="">
		</div>
		<div class="team__content">
				...
				<div class="swiper-slide">
					<div class="testimonial__items text-center">
						<div class="testimonial__items--thumbnail">
							...
							src="{{asset('web/assets/img/other/testimonial-thumb1.png')}}" alt="testimonial-img">
						</div>
						<div class="testimonial__items--content">
							...
							<p class="testimonial__items--desc">Lorem ipsum dolor sit amet, consectetur
								adipisicin elit, sed do eiusmod tempor incididunt ut labore et dolore magna
...
<div class="swiper-slide">
	<div class="testimonial__items text-center">
		<div class="testimonial__items--thumbnail">
			<img class="testimonial__items--thumbnail__img border-radius-50"
			src="{{asset('web/assets/img/other/testimonial-thumb2.png')}}" alt="testimonial-img">
		</div>
		<div class="testimonial__items--content">
			<h3 class="testimonial__items--title">Nike Mardson</h3>
			<span class="testimonial__items--subtitle">fashion</span>
...
<div class="swiper-slide">
	<div class="testimonial__items text-center">
		<div class="testimonial__items--thumbnail">
			<img class="testimonial__items--thumbnail__img border-radius-50"
			src="{{asset('web/assets/img/other/testimonial-thumb3.png')}}" alt="testimonial-img">
		</div>
		<div class="testimonial__items--content">
			<h3 class="testimonial__items--title">Nike Mardson</h3>
			<span class="testimonial__items--subtitle">fashion</span>
			...
			<div class="col">
				<div class="brand__logo--section__inner d-flex justify-content-center align-items-center">
					<div class="brand__logo--items">
						...
						src="{{asset('web/assets/img/logo/brand-logo1.png')}}" alt="brand logo">
					</div>
					<div class="brand__logo--items">
						<img class="brand__logo--items__thumbnail--img display-block"
						src="{{asset('web/assets/img/logo/brand-logo2.png')}}" alt="brand logo">
					</div>
					<div class="brand__logo--items">
						<img class="brand__logo--items__thumbnail--img display-block"
						src="{{asset('web/assets/img/logo/brand-logo3.png')}}" alt="brand logo">
					</div>
					<div class="brand__logo--items">
						<img class="brand__logo--items__thumbnail--img display-block"
						src="{{asset('web/assets/img/logo/brand-logo4.png')}}" alt="brand logo">
					</div>
					<div class="brand__logo--items">
						<img class="brand__logo--items__thumbnail--img display-block"
						src="{{asset('web/assets/img/logo/brand-logo5.png')}}" alt="brand logo">
					</div>
				</div>
			</div>
		</div>
