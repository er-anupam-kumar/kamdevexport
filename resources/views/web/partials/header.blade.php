            ...
            <div class="header__topbar--inner d-flex align-items-center justify-content-between">
                <div class="header__shipping">
                    <ul class="header__shipping--wrapper d-flex">
                        <li class="header__shipping--text text-white">Welcome to Kamdev Export online Store</li>
                        <li class="header__shipping--text text-white d-sm-2-none"><img class="header__shipping--text__icon" src="{{asset('web/assets/img/icon/bus.png')}}" alt="bus-icon"> Track Your Order</li>
                        <li class="header__shipping--text text-white d-sm-2-none"><img class="header__shipping--text__icon" src="{{asset('web/assets/img/icon/email.png')}}" alt="email-icon"> <a class="header__shipping--text__link" href="mailto:support@kamdevexport.com">support@kamdevexport.com</a></li>
                    </ul>
                </div>
        ...
        <div class="container-fluid">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1 class="main__logo--title" style="font-size: 3rem !important; color: #ee2761;"><a class="main__logo--link" href="{{url('/')}}">
                        KAMDEV EXPORT{{-- <img class="main__logo--img" src="{{asset('web/assets/img/logo/nav-log.png')}}" alt="logo-img"> --}}
                    </a></h1>
                </div>
...
<div class="header__bottom">
    <div class="container-fluid">
        <div class="header__bottom--inner position__relative d-none d-lg-flex justify-content-between align-items-center">
            ...
            <p class="header__discount--text"><img class="header__discount--icon__img" src="{{asset('web/assets/img/icon/lamp.png')}}" alt="lamp-img"> Special up to 60% Off all item</p>
        </div>
    </div>
</div>
    ...
    <div class="offcanvas__inner">
        <div class="offcanvas__logo">
            <a class="offcanvas__logo_link" href="{{url('/')}}">
                <img src="{{asset('web/assets/img/logo/nav-log.png')}}" alt="Grocee Logo" width="158" height="36">
            </a>
    ...
    <div class="minicart__product">
        <div class="minicart__product--items d-flex">
            <div class="minicart__thumb">
                <a href="{{url('/')}}"><img src="{{asset('web/assets/img/product/product1.png')}}" alt="prduct-img"></a>
            </div>
            <div class="minicart__text">
                <h3 class="minicart__subtitle h4"><a href="{{url('/')}}">Oversize Cotton Dress</a></h3>
        ...
        <div class="minicart__product--items d-flex">
            <div class="minicart__thumb">
                <a href="{{url('/')}}"><img src="{{asset('web/assets/img/product/product2.png')}}" alt="prduct-img"></a>
            </div>
            <div class="minicart__text">
                <h3 class="minicart__subtitle h4"><a href="{{url('/')}}">Boxy Denim Jacket</a></h3>
