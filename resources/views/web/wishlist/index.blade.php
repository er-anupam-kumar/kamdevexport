								...
								<tbody class="cart__table--body">
									<tr class="cart__table--body__items">
										...
										<div class="cart__thumbnail">
											...
											<div class="cart__content">
												<h4 class="cart__content--title"><a
													href="{{url('/')}}">Fresh-whole-fish</a></h4>
										...
										<td class="cart__table--body__list text-right">
											<a class="wishlist__cart--btn primary__btn" href="{{url('/cart')}}">Add To Cart</a>
										</td>
									</tr>
									<tr class="cart__table--body__items">
										<td class="cart__table--body__list">
										...
										<div class="cart__thumbnail">
											...
											<div class="cart__content">
												<h4 class="cart__content--title"><a
													href="{{url('/')}}">Vegetable-healthy</a></h4>
													<span class="cart__content--variant">COLOR: Blue</span>
													<span class="cart__content--variant">WEIGHT: 2 Kg</span>
												</div>
											</div>
									...
									<tr class="cart__table--body__items">
										...
										<div class="cart__thumbnail">
											...
											<div class="cart__content">
												<h4 class="cart__content--title"><a
													href="{{url('/')}}">Raw-onions-surface</a></h4>
													<span class="cart__content--variant">COLOR: Blue</span>
													<span class="cart__content--variant">WEIGHT: 2 Kg</span>
												</div>
											</div>
									...
									<tr class="cart__table--body__items">
										...
										<div class="cart__thumbnail">
											...
											<div class="cart__content">
												<h4 class="cart__content--title"><a
													href="{{url('/')}}">Oversize Cotton Dress</a></h4>
													<span class="cart__content--variant">COLOR: Blue</span>
													<span class="cart__content--variant">WEIGHT: 2 Kg</span>
												</div>
											</div>
