                                                ...
                                                <td class="cart__table--body__list">
                                                    <div class="cart__product d-flex align-items-center">
                                                        ...
                                                        <div class="cart__thumbnail">
                                                            <a href="{{url('/')}}"><img class="border-radius-5"
                                                                    src="{{url('web/assets/img/product/product1.png')}}"
                                                                    alt="cart-product"></a>
                                                        </div>
                                                        <div class="cart__content">
                                                            <h4 class="cart__content--title"><a
                                                                    href="{{url('/')}}">Fresh-whole-fish</a>
                                                            </h4>
                                            ...
                                            <tr class="cart__table--body__items">
                                                <td class="cart__table--body__list">
                                                    <div class="cart__product d-flex align-items-center">
                                                        ...
                                                        <div class="cart__thumbnail">
                                                            <a href="{{url('/')}}"><img class="border-radius-5"
                                                                    src="{{url('web/assets/img/product/product2.png')}}"
                                                                    alt="cart-product"></a>
                                                        </div>
                                                        <div class="cart__content">
                                                            <h4 class="cart__content--title"><a
                                                                    href="{{url('/')}}">Vegetable-healthy</a>
                                                            </h4>
                                                            <span class="cart__content--variant">COLOR: Blue</span>
                                                            <span class="cart__content--variant">WEIGHT: 2 Kg</span>
                                                        </div>
                                            ...
                                            <tr class="cart__table--body__items">
                                                <td class="cart__table--body__list">
                                                    <div class="cart__product d-flex align-items-center">
                                                        ...
                                                        <div class="cart__thumbnail">
                                                            <a href="{{url('/')}}"><img class="border-radius-5"
                                                                    src="{{url('web/assets/img/product/product3.png')}}"
                                                                    alt="cart-product"></a>
                                                        </div>
                                                        <div class="cart__content">
                                                            <h4 class="cart__content--title"><a
                                                                    href="{{url('/')}}">Raw-onions-surface</a>
                                                            </h4>
                                                            <span class="cart__content--variant">COLOR: Blue</span>
                                                            <span class="cart__content--variant">WEIGHT: 2 Kg</span>
                                                        </div>
                                            ...
                                            <tr class="cart__table--body__items">
                                                <td class="cart__table--body__list">
                                                    <div class="cart__product d-flex align-items-center">
                                                        ...
                                                        <div class="cart__thumbnail">
                                                            <a href="{{url('/')}}"><img class="border-radius-5"
                                                                    src="{{url('web/assets/img/product/product4.png')}}"
                                                                    alt="cart-product"></a>
                                                        </div>
                                                        <div class="cart__content">
                                                            <h4 class="cart__content--title"><a
                                                                    href="{{url('/')}}">Oversize Cotton
                                                                    Dress</a></h4>
                                                            <span class="cart__content--variant">COLOR: Blue</span>
                                                            <span class="cart__content--variant">WEIGHT: 2 Kg</span>
                                                        </div>
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="{{url('/')}}">
                                        <img class="product__items--img product__primary--img"
                                            src="{{url('web/assets/img/product/product1.png')}}" alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{url('web/assets/img/product/product2.png')}}" alt="product-img">
                                    </a>
                                ...
                                <div class="product__items--content">
                                    ...
                                    <h3 class="product__items--content__title h4"><a
                                            href="{{url('/')}}">Oversize Cotton Dress</a></h3>
                                    ...
                                    <ul class="product__items--action d-flex">
                                        ...
                                        <li class="product__items--action__list">
                                            <a class="product__items--action__btn" href="{{url('/wishlist')}}">
                                                <svg class="product__items--action__btn--svg"
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="{{url('/')}}">
                                        <img class="product__items--img product__primary--img"
                                            src="{{url('web/assets/img/product/product3.png')}}" alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{url('web/assets/img/product/product4.png')}}" alt="product-img">
                                    </a>
                                    <div class="product__badge">
                                        <span class="product__badge--items sale">Sale</span>
                                    </div>
                                ...
                                <div class="product__items--content">
                                    <span class="product__items--content__subtitle">Jacket, Women</span>
                                    <h3 class="product__items--content__title h4"><a href="{{url('/')}}">Boxy
                                            Denim Jacket</a></h3>
                                    <div class="product__items--price">
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="{{url('/')}}">
                                        <img class="product__items--img product__primary--img"
                                            src="{{url('web/assets/img/product/product5.png')}}" alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{url('web/assets/img/product/product11.png')}}" alt="product-img">
                                    </a>
                                    <div class="product__badge">
                                        <span class="product__badge--items sale">Sale</span>
                                    </div>
                                ...
                                <div class="product__items--content">
                                    <span class="product__items--content__subtitle">Jacket, Women</span>
                                    <h4 class="product__items--content__title"><a href="{{url('/')}}">Quilted
                                            Shoulder Bag</a></h4>
                                    <div class="product__items--price">
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="{{url('/')}}">
                                        <img class="product__items--img product__primary--img"
                                            src="{{url('web/assets/img/product/product8.png')}}" alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{url('web/assets/img/product/product15.png')}}" alt="product-img">
                                    </a>
                                    <div class="product__badge">
                                        <span class="product__badge--items sale">Sale</span>
                                    </div>
                                ...
                                <div class="product__items--content">
                                    <span class="product__items--content__subtitle">Jacket, Women</span>
                                    <h4 class="product__items--content__title"><a href="{{url('/')}}">Square
                                            Shoulder Bag</a></h4>
                                    <div class="product__items--price">
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="{{url('/')}}">
                                        <img class="product__items--img product__primary--img"
                                            src="{{url('web/assets/img/product/product12.png')}}" alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{url('web/assets/img/product/product13.png')}}" alt="product-img">
                                    </a>
                                    <div class="product__badge">
                                        <span class="product__badge--items sale">Sale</span>
                                    </div>
                                ...
                                <div class="product__items--content">
                                    <span class="product__items--content__subtitle">Jacket, Women</span>
                                    <h4 class="product__items--content__title"><a href="{{url('/')}}">Wool-blend
                                            Jacket</a></h4>
                                    <div class="product__items--price">
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="{{url('/')}}">
                                        <img class="product__items--img product__primary--img"
                                            src="{{url('web/assets/img/product/product14.png')}}" alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{url('web/assets/img/product/product15.png')}}" alt="product-img">
                                    </a>
                                    <div class="product__badge">
                                ...
                                <div class="product__items--content">
                                    <span class="product__items--content__subtitle">Jacket, Women</span>
                                    <h4 class="product__items--content__title"><a href="{{url('/')}}">Western
                                            denim shirt</a></h4>
                                    <div class="product__items--price">
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                ...
                                <div class="product__items--content">
                                    <span class="product__items--content__subtitle">Jacket, Women</span>
                                    <h4 class="product__items--content__title"><a href="{{url('/')}}">Aware
                                            organic cotton</a></h4>
                                    <div class="product__items--price">
                        ...
                        <div class="brand__logo--section__inner d-flex justify-content-center align-items-center">
                            <div class="brand__logo--items">
                                <img class="brand__logo--items__thumbnail--img display-block"
                                    src="{{url('web/assets/img/logo/brand-logo1.png')}}" alt="brand logo">
                            </div>
                            <div class="brand__logo--items">
                                <img class="brand__logo--items__thumbnail--img display-block"
                                    src="{{url('web/assets/img/logo/brand-logo2.png')}}" alt="brand logo">
                            </div>
                            <div class="brand__logo--items">
                                <img class="brand__logo--items__thumbnail--img display-block"
                                    src="{{url('web/assets/img/logo/brand-logo3.png')}}" alt="brand logo">
                            </div>
                            <div class="brand__logo--items">
                                <img class="brand__logo--items__thumbnail--img display-block"
                                    src="{{url('web/assets/img/logo/brand-logo4.png')}}" alt="brand logo">
                            </div>
                            <div class="brand__logo--items">
                                <img class="brand__logo--items__thumbnail--img display-block"
                                    src="{{url('web/assets/img/logo/brand-logo5.png')}}" alt="brand logo">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="shipping__section2--inner shipping__style3--inner d-flex justify-content-between">
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                            <img src="{{url('web/assets/img/other/shipping1.png')}}" alt="">
                        </div>
                    ...
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                            <img src="{{url('web/assets/img/other/shipping2.png')}}" alt="">
                        </div>
                        <div class="shipping__items2--content">
                    ...
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                            <img src="{{url('web/assets/img/other/shipping3.png')}}" alt="">
                        </div>
                        <div class="shipping__items2--content">
                    ...
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                            <img src="{{url('web/assets/img/other/shipping4.png')}}" alt="">
                        </div>
                        <div class="shipping__items2--content">
