                ...
                <div class="main checkout__mian">
                                                    ...
                                                    <div class="product__image two  d-flex align-items-center">
                                                        <div class="product__thumbnail border-radius-5">
                                                            <a href="{{url('/')}}"><img class="border-radius-5"
                                                                    src="{{url('web/assets/img/product/small-product7.png')}}"
                                                                    alt="cart-product"></a>
                                            ...
                                            <tr class="summary__table--items">
                                                <td class=" summary__table--list">
                                                    <div class="cart__product d-flex align-items-center">
                                                        <div class="product__thumbnail border-radius-5">
                                                            <a href="{{url('/')}}"><img class="border-radius-5"
                                                                    src="{{url('web/assets/img/product/small-product2.png')}}"
                                                                    alt="cart-product"></a>
                                                            <span class="product__thumbnail--quantity">1</span>
                                                        </div>
                                                        <div class="product__description">
                                            ...
                                            <tr class=" summary__table--items">
                                                <td class=" summary__table--list">
                                                    <div class="cart__product d-flex align-items-center">
                                                        <div class="product__thumbnail border-radius-5">
                                                            <a href="{{url('/')}}"><img class="border-radius-5"
                                                                    src="{{url('web/assets/img/product/small-product4.png')}}"
                                                                    alt="cart-product"></a>
                                                            <span class="product__thumbnail--quantity">1</span>
                                                        </div>
                                                        <div class="product__description">
                    ...
                    <main class="main__content_wrapper">
                        <form action="#">
                            <div class="checkout__content--step section__contact--information">
                                <div
                                    ...
                                    <p class="layout__flex--item">
                                        ...
                                        <a class="layout__flex--item__link" href="{{url('/')}}">Log in</a>
                                    </p>
                                </div>
                            ...
                            <div class="checkout__content--step__footer d-flex align-items-center mb-5">
                                <a class="continue__shipping--btn primary__btn border-radius-5"
                                    href="{{url('/')}}">Place Order</a>
                                ...
                                <tr class="cart__table--body__items">
                                    <td class="cart__table--body__list">
                                        <div class="product__image two  d-flex align-items-center">
                                            ...
                                            <div class="product__description">
                                                <h3 class="product__description--name h4"><a
                                                        href="{{url('/')}}">Fresh-whole-fish</a></h3>
                                ...
                                <tr class="cart__table--body__items">
                                    <td class="cart__table--body__list">
                                        <div class="cart__product d-flex align-items-center">
                                            ...
                                            <div class="product__description">
                                                <h3 class="product__description--name h4"><a
                                                        href="{{url('/')}}">Vegetable-healthy</a></h3>
                                ...
                                <tr class="cart__table--body__items">
                                    <td class="cart__table--body__list">
                                        <div class="cart__product d-flex align-items-center">
                                            ...
                                            <div class="product__description">
                                                <h3 class="product__description--name h4"><a
                                                        href="{{url('/')}}">Raw-onions-surface</a></h3>
