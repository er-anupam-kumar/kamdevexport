		...
		<div class="row mb--n28">
			<div class="col-lg-5 col-md-order mb-28">
				<div class="banner__items">
					<a class="banner__items--thumbnail position__relative" href="{{url('/')}}"><img class="banner__items--thumbnail__img" src="{{asset('web/assets/img/banner/banner1.png')}}" alt="banner-img">
			...
			<div class="col-lg-7 mb-28">
				<div class="row row-cols-lg-2 row-cols-sm-2 row-cols-1">
					<div class="col mb-28">
						<div class="banner__items">
							<a class="banner__items--thumbnail position__relative" href="{{url('/')}}"><img class="banner__items--thumbnail__img" src="{{asset('web/assets/img/banner/banner2.png')}}" alt="banner-img"> 
								<div class="banner__items--content">
					...
					<div class="col mb-28">
						<div class="banner__items">
							<a class="banner__items--thumbnail position__relative" href="{{url('/')}}"><img class="banner__items--thumbnail__img" src="{{asset('web/assets/img/banner/banner3.png')}}" alt="banner-img"> 
								<div class="banner__items--content">
				...
				<div class="banner__items">
					<a class="banner__items--thumbnail position__relative" href="{{url('/')}}"><img class="banner__items--thumbnail__img banner__img--max__height" src="{{asset('web/assets/img/banner/banner4.png')}}" alt="banner-img"> 
						<div class="banner__items--content">
					...
					<div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30">
						<div class="col mb-30">
							<div class="product__items ">
								<div class="product__items--thumbnail">
									<a class="product__items--link" href="{{url('/')}}">
										<img class="product__items--img product__primary--img" src="{{asset('web/assets/img/product/product1.png')}}" alt="product-img">
										<img class="product__items--img product__secondary--img" src="{{asset('web/assets/img/product/product2.png')}}" alt="product-img">
									</a>
								...
								<div class="product__items--content">
									...
									<h3 class="product__items--content__title h4"><a href="{{url('/')}}">Oversize Cotton Dress</a></h3>
									...
									<ul class="product__items--action d-flex">
										<li class="product__items--action__list">
											<a class="product__items--action__btn add__to--cart" href="{{url('/')}}">
										...
										<li class="product__items--action__list">
											<a class="product__items--action__btn" href="{{url('/')}}">
						...
						<div class="col mb-30">
							<div class="product__items ">
								<div class="product__items--thumbnail">
									<a class="product__items--link" href="{{url('/')}}">
										<img class="product__items--img product__primary--img" src="{{asset('web/assets/img/product/product3.png')}}" alt="product-img">
										<img class="product__items--img product__secondary--img" src="{{asset('web/assets/img/product/product4.png')}}" alt="product-img">
									</a>
									<div class="product__badge">
										<span class="product__badge--items sale">Sale</span>
									</div>
								...
								<div class="product__items--content">
									<span class="product__items--content__subtitle">Jacket, Women</span>
									<h3 class="product__items--content__title h4"><a href="{{url('/')}}">Boxy Denim Jacket</a></h3>
									<div class="product__items--price">
						...
						<div class="col mb-30">
							<div class="product__items ">
								<div class="product__items--thumbnail">
									<a class="product__items--link" href="{{url('/')}}">
										<img class="product__items--img product__primary--img" src="{{asset('web/assets/img/product/product5.png')}}" alt="product-img">
										<img class="product__items--img product__secondary--img" src="{{asset('web/assets/img/product/product11.png')}}" alt="product-img">
									</a>
									<div class="product__badge">
										<span class="product__badge--items sale">Sale</span>
									</div>
								...
								<div class="product__items--content">
									<span class="product__items--content__subtitle">Jacket, Women</span>
									<h4 class="product__items--content__title"><a href="{{url('/')}}">Quilted Shoulder Bag</a></h4>
									<div class="product__items--price">
						...
						<div class="col mb-30">
							<div class="product__items ">
								<div class="product__items--thumbnail">
									<a class="product__items--link" href="{{url('/')}}">
										<img class="product__items--img product__primary--img" src="{{asset('web/assets/img/product/product6.png')}}" alt="product-img">
										<img class="product__items--img product__secondary--img" src="{{asset('web/assets/img/product/product7.png')}}" alt="product-img">
									</a>
									<div class="product__badge">
										<span class="product__badge--items sale">Sale</span>
									</div>
								...
								<div class="product__items--content">
									<span class="product__items--content__subtitle">Jacket, Women</span>
									<h4 class="product__items--content__title"><a href="{{url('/')}}">High Ankle Jeans</a></h4>
									<div class="product__items--price">
						...
						<div class="col mb-30">
							<div class="product__items ">
								<div class="product__items--thumbnail">
									<a class="product__items--link" href="{{url('/')}}">
										<img class="product__items--img product__primary--img" src="{{asset('web/assets/img/product/product8.png')}}" alt="product-img">
										<img class="product__items--img product__secondary--img" src="{{asset('web/assets/img/product/product15.png')}}" alt="product-img">
									</a>
									<div class="product__badge">
										<span class="product__badge--items sale">Sale</span>
									</div>
								...
								<div class="product__items--content">
									<span class="product__items--content__subtitle">Jacket, Women</span>
									<h4 class="product__items--content__title"><a href="{{url('/')}}">Square Shoulder Bag</a></h4>
									<div class="product__items--price">
						...
						<div class="col mb-30">
							<div class="product__items ">
								<div class="product__items--thumbnail">
									<a class="product__items--link" href="{{url('/')}}">
										<img class="product__items--img product__primary--img" src="{{asset('web/assets/img/product/product9.png')}}" alt="product-img">
										<img class="product__items--img product__secondary--img" src="{{asset('web/assets/img/product/product10.png')}}" alt="product-img">
									</a>
									<div class="product__badge">
										<span class="product__badge--items sale">Sale</span>
									</div>
								...
								<div class="product__items--content">
									<span class="product__items--content__subtitle">Jacket, Women</span>
									<h4 class="product__items--content__title"><a href="{{url('/')}}">Light Denim Jacket</a></h4>
									<div class="product__items--price">
						...
						<div class="col mb-30">
							<div class="product__items ">
								<div class="product__items--thumbnail">
									<a class="product__items--link" href="{{url('/')}}">
										<img class="product__items--img product__primary--img" src="{{asset('web/assets/img/product/product12.png')}}" alt="product-img">
										<img class="product__items--img product__secondary--img" src="{{asset('web/assets/img/product/product13.png')}}" alt="product-img">
									</a>
									<div class="product__badge">
										<span class="product__badge--items sale">Sale</span>
									</div>
								...
								<div class="product__items--content">
									<span class="product__items--content__subtitle">Jacket, Women</span>
									<h4 class="product__items--content__title"><a href="{{url('/')}}">Wool-blend Jacket</a></h4>
									<div class="product__items--price">
						...
						<div class="col mb-30">
							<div class="product__items ">
								<div class="product__items--thumbnail">
									<a class="product__items--link" href="{{url('/')}}">
										<img class="product__items--img product__primary--img" src="{{asset('web/assets/img/product/product11.png')}}" alt="product-img">
										<img class="product__items--img product__secondary--img" src="{{asset('web/assets/img/product/product8.png')}}" alt="product-img">
									</a>
									<div class="product__badge">
										<span class="product__badge--items sale">Sale</span>
									</div>
								...
								<div class="product__items--content">
									<span class="product__items--content__subtitle">Jacket, Women</span>
									<h4 class="product__items--content__title"><a href="{{url('/')}}">Aware organic cotton</a></h4>
									<div class="product__items--price">
						...
						<div class="col mb-30">
							<div class="product__items ">
								<div class="product__items--thumbnail">
									<a class="product__items--link" href="{{url('/')}}">
										<img class="product__items--img product__primary--img" src="{{asset('web/assets/img/product/product14.png')}}" alt="product-img">
										<img class="product__items--img product__secondary--img" src="{{asset('web/assets/img/product/product15.png')}}" alt="product-img">
									</a>
									<div class="product__badge">
										<span class="product__badge--items sale">Sale</span>
								...
								<div class="product__items--content">
									<span class="product__items--content__subtitle">Jacket, Women</span>
									<h4 class="product__items--content__title"><a href="{{url('/')}}">Western denim shirt</a></h4>
									<div class="product__items--price">
						...
						<div class="col mb-30">
							<div class="product__items ">
								<div class="product__items--thumbnail">
									<a class="product__items--link" href="{{url('/')}}">
										<img class="product__items--img product__primary--img" src="{{asset('web/assets/img/product/product2.png')}}" alt="product-img">
										<img class="product__items--img product__secondary--img" src="{{asset('web/assets/img/product/product1.png')}}" alt="product-img">
									</a>
									<div class="product__badge">
										<span class="product__badge--items sale">Sale</span>
									</div>
								...
								<div class="product__items--content">
									<span class="product__items--content__subtitle">Jacket, Women</span>
									<h4 class="product__items--content__title"><a href="{{url('/')}}">OSmock Mini Dresss</a></h4>
									<div class="product__items--price">
		...
		<div class="row row-cols-md-2 row-cols-1 mb--n28">
			<div class="col mb-28">
				<div class="banner__items position__relative">
					<a class="banner__items--thumbnail " href="{{url('/')}}"><img class="banner__items--thumbnail__img banner__img--max__height" src="{{asset('web/assets/img/banner/banner5.png')}}" alt="banner-img">
						<div class="banner__items--content">
			...
			<div class="col mb-28">
				<div class="banner__items position__relative">
					<a class="banner__items--thumbnail " href="{{url('/')}}"><img class="banner__items--thumbnail__img banner__img--max__height" src="{{asset('web/assets/img/banner/banner6.png')}}" alt="banner-img">
						<div class="banner__items--content">
		...
		<div class="testimonial__section--inner testimonial__swiper--activation swiper">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="testimonial__items text-center">
						<div class="testimonial__items--thumbnail">
							<img class="testimonial__items--thumbnail__img border-radius-50" src="{{asset('web/assets/img/other/testimonial-thumb1.png')}}" alt="testimonial-img">
						</div>
				...
				<div class="swiper-slide">
					<div class="testimonial__items text-center">
						<div class="testimonial__items--thumbnail">
							<img class="testimonial__items--thumbnail__img border-radius-50" src="{{asset('web/assets/img/other/testimonial-thumb2.png')}}" alt="testimonial-img">
						</div>
						<div class="testimonial__items--content">
				...
				<div class="swiper-slide">
					<div class="testimonial__items text-center">
						<div class="testimonial__items--thumbnail">
							<img class="testimonial__items--thumbnail__img border-radius-50" src="{{asset('web/assets/img/other/testimonial-thumb3.png')}}" alt="testimonial-img">
						</div>
						<div class="testimonial__items--content">
		...
		<div class="row row-cols-1">
			<div class="col">
				<div class="banner__section--inner position__relative">
					<a class="banner__items--thumbnail display-block" href="{{url('/')}}"><img class="banner__items--thumbnail__img banner__img--height__md display-block" src="{{asset('web/assets/img/banner/banner-bg2.png')}}" alt="banner-img">
